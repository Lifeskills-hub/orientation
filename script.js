...
const locations = [
  { x: 1550, y: -928, clue: "Blk 4 Level 4 - Outside LFS Staff Room" },
  { x: 1762, y: -1014, clue: "Outside library Blk 3 Lvl 5" },
  { x: 856 , y: -894, clue: "Sports Hall Blk 7 Lvl 2" },
  { x: 1326, y: -826, clue: "Beside SAC room Blk 5 lvl 4" },
  { x: 966, y: -864, clue: "Outside gym" },
  { x: 1636, y: -700, clue: "Blk 1 lvl 2 the empty space beside the customer & visitor center (beside the escalator) " },
  { x: 1316, y: -664, clue: "Fitness@West (Blk 1 lvl 1)" },
  { x: 1296, y: -660, clue: "Open space infront of Experienced ITE Centre (Level 4 - Above the level 3 canteen)" },
  { x: 1780, y: -702, clue: "PULSE (Blk 2 Lvl 2)" },
  { x: 1768, y: -688, clue: "Black Box" },
  { x: 1802, y: -1084, clue: "Flair studio" },
  { x: 1302, y: -760, clue: "Circular plant area between Blk 5 and Blk 1" },
  { x: 984, y: -842, clue: "Open space in front of Staff Gym (Level 4)" },
  { x: 1336, y: -658, clue: "Space outside JCS@West" },
  { x: 1792, y: -688, clue: "Level 7 Open Space outside Auditorium (Above Sky Lobby)" },
  { x: 1820, y: -842, clue: "Level 4 walkaway the curve around piazza" },
